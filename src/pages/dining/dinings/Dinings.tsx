...
import DiningsCards from "./components/DiningsCards";
...
const Dinings = () => {
  ...
  return (
    <PageContainer
      title={"Cajas"}
      description="Gestion de cajas de comedor"
        ...
        <Grid item xs={12} sm={12} md={9} lg={9}>
          <Box height={"50%"}>
            {viewMode === "table" ? (
              ...
              <DiningsCards itemsPerPage={isMobile ? 4 : 6} />
            )}
          </Box>
        </Grid>
        <Grid item xs={12} sm={12} md={3} lg={3}>
          {todayDiningError && todayDiningError?.status !== 404 ? (
            ...
            <>
              ...
              <Box>
                <TodayAssistancesCard
                  data={todayDining}
                  loading={todayDiningLoading}
                  error={!!todayDiningError}
                />
              </Box>
            </>
